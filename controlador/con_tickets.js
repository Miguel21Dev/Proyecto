...
const obtenerTicketsAdmin = async () => {
    try {
        ...
        return { success: false, message: 'Error al obtener tickets: ' + error.message };
    }
}
...
const asignarTicket = async (ticket_id, prioridad, tecnico_codigo) => {
    try {
        ...
        const result = await this.pool.query(sql, [prioridad, nombre_tecnico, ticket_id]);
        ...
        return { success: false, message: 'Error al asignar ticket: ' + error.message };
    }
}

// Actualizar estado de un ticket (para técnicos)
const actualizarEstado = async (ticket_id, nuevo_estado, tecnico_nombre = null) => {
    try {
...
const obtenerTicket = async (ticket_id) => {
    try {
        ...
        return { success: false, message: 'Error al obtener ticket: ' + error.message };
    }
}
...
module.exports = { actualizarEstado, asignarTicket, crearTicket, eliminarTicket, obtenerTicketsAdmin, obtenerTicketsTecnico, obtenerNombreTecnico , obtenerTecnicos, obtenerTicket };